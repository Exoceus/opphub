...
export default class NewOpportunity extends Component {
            ...
            axios.get('/api/org/UID/' + firebase_uid)
                .then(response => {
                    ...
                    this.setState({
                        ...
                        temp_host_name: this.state.host.host_name
                    })
    ...
    onSubmit(e) {
        ...
        if (!this.state.sector.length <= 0 && !this.state.position_type.length <= 0 && !this.state.target_demo.length <= 0) {
            const opp = {
                ...
                suggestion: true,
                opp_img: this.state.host.profile_pic,
                ...
                <div className="dropdown-item-wrap">
                    ...
                    >
                        ...
                        <optgroup label="Scholarship">
                            <option value="Conference">Academic Scholarship</option>
                            <option value="Lectures">Community Service Scholarships</option>
                            <option value="Seminar">Athletic Scholarship</option>
                    ...
                    <form onSubmit={this.onSubmit} className="add-opp-form">
                        ...
                        <div className="grid-3">
                            <div className="form-group">
                                ...
                                <input type="date" value={this.state.due_date} onChange={this.onChangeDueDate} required></input>
                            </div>
                            <div className="form-group">
                        ...
                        <div className="form-group">
                            ...
                            <div onChange={this.onChangeOnline} className="hosted-options-wrapper">
                                <div> <input type="radio" value="Online" name="hosted" required /> Online</div>
